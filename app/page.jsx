    ...
    <main className="flex flex-col gap-8 sm:gap-16 pt-12 sm:pt-16 md:pt-20 text-lg sm:text-xl md:text-2xl bg-black">
        <section className="bg-customBlue flex flex-col items-center sm:flex-row sm:justify-between sm:items-center gap-8 p-12">
            ...
            <div className="flex justify-end">
                <Image src={rockett} alt="Cohete 1" title="GIF de David Montero de Pixabay" className="hidden sm:block" width="400" />
            </div>
        </section>
        ...
        <section className="bg-customBlue flex flex-col items-center sm:flex-row sm:justify-between sm:items-center -mt-8 sm:-mt-16 md:-mt-16 lg:-mt-16 h-610px md:h-843px overflow-hidden">
            <div className="flex flex-col items-start text-left p-12 sm:w-1/2">
                ...
                <p className="font-medium text-black text-sm sm:text-md md:text-lg lg:text-xl leading-normal mt-5">Nuestro servicio de social media mensual es tu solución integral para una presencia efectiva en línea. Nos encargamos de gestionar tus perfiles en redes sociales, creando contenido cautivador y relevante que conecte con tu audiencia.</p>
                <p className="mt-5"><a href="#contacto" className="inline-block px-6 py-3 rounded-full bg-white text-customBlue hover:bg-opacity-80 transition duration-300 ease-in-out no-underline font-semibold text-base">Conoce más</a></p>
            </div>
        ...
        <section className="bg-white flex flex-col-reverse items-center sm:flex-row sm:justify-between sm:items-center -mt-8 sm:-mt-16 md:-mt-16 lg:-mt-16 h-610px md:h-843px overflow-hidden">
            ...
            <div className="flex flex-col items-start text-left p-12 sm:w-1/2">
                ...
                <p className="mt-5"><a href="#contacto" className="inline-block px-6 py-3 rounded-full bg-customBlue text-white hover:bg-opacity-80 transition duration-300 ease-in-out no-underline font-semibold text-base">Conoce más</a></p>
            </div>
        </section>
        <section className="bg-customBlue flex flex-col items-center sm:flex-row sm:justify-between sm:items-center -mt-8 sm:-mt-16 md:-mt-16 lg:-mt-16 h-610px md:h-843px overflow-hidden">
            <div className="flex flex-col items-start text-left p-12 sm:w-1/2">
        ...
        <section className="bg-white flex flex-col-reverse items-center sm:flex-row sm:justify-between sm:items-center -mt-8 sm:-mt-16 md:-mt-16 lg:-mt-16 h-610px md:h-843px overflow-hidden">
            ...
            <div className="flex flex-col items-start text-left p-12 sm:w-1/2">
                ...
                <p className="mt-5"><a href="#contacto" className="inline-block px-6 py-3 rounded-full bg-customBlue text-whitee hover:bg-opacity-80 transition duration-300 ease-in-out no-underline font-semibold text-base">Conoce más</a></p>
            </div>
        </section>
